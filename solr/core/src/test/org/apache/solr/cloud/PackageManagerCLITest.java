...
public class PackageManagerCLITest extends SolrCloudTestCase {
  ...
  // $ openssl dgst -sha512 -sign ./solr/core/src/test-files/solr/question-answer-repository-private-key.pem ./solr/core/src/test-files/solr/question-answer-repository/question-answer-request-handler-1.1.jar | openssl enc -base64
